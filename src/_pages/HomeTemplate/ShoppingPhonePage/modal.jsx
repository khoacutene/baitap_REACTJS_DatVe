...
import { setUpdateQty } from "./duck/reducer";

export default function Modal() {
  const carts = useSelector((state)=>{
    return state.ShoppingPhoneReducer.carts;
  })
      ...
      return (
        ...
        >
          ...
          <td className="px-6 py-4">
            <button
              onClick={() => {
                dispatch(setUpdateQty({maSP: phone.maSP, status: false}))
              }}
              type="button"
            ...
            <button
              onClick={() => {
                dispatch(setUpdateQty({maSP: phone.maSP, status: true}))
              }}
              type="button"
